...
namespace spc {
int
imageToModelSpace(const Pt2dr &pt2d, const cElNuage3DMaille  &aNuage, Pt3dr &pt3d)
{
    // NOTE we are assuming the pt2d that the user passes is ensured to be inside the image's dimensions!!
