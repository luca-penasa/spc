...
template <typename ScalarT> class TimeSeriesWriter
{
public:
    TimeSeriesWriter();

    void setInputSeries(typename spc::TimeSeriesBase<ScalarT>::Ptr in_series)
    {
...
private:
    typename spc::TimeSeriesBase<ScalarT>::Ptr in_series_;
