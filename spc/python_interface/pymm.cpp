                                                      ...
                                                      boost::python::str nuage_filename)
{
    ...
    for (size_t i = 0; i < n_points; ++i )
        points2d.push_back(Pt2dr(boost::python::extract<double>( pts2d[i][0] ),  boost::python::extract<double>( pts2d[i][1] )));


    cElNuage3DMaille *  aNuage = cElNuage3DMaille::FromFileIm(pythonStr2cstr(nuage_filename));
                                            ...
                                            boost::python::str orientation_filename)
{
    ...
    ElCamera * cam  = Gen_Cam_Gen_From_File(true,pythonStr2cstr(orientation_filename),aNameTag,anICNM);
    ...
    for (size_t i = 0; i < n_points; ++i )
        points3d.push_back(Pt3dr(boost::python::extract<double>( pts3d[i][0] ),  boost::python::extract<double>( pts3d[i][1] ), boost::python::extract<double>( pts3d[i][2] )));
